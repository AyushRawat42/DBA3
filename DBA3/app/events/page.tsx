...
const events = [
  ...
  },
  {
    ...
    location: "Dehradun Sports Complex, Dehradun",
    category: "Championship",
    description: "Dedicated championship for women boxers across all age categories and weight classes.",
  ...
  },
  {
    ...
    location: "DBA Training Center, Dehradun",
    category: "Tournament",
    description: "Open tournament welcoming boxers from across the region of all skill levels.",
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="bg-secondary text-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/80">Boxing tournaments, championships, and training events</p>
        </div>
      </section>
            ...
            {events.map((event) => (
              <Card key={event.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                <div className="md:flex h-full">
                  {/* Date Badge */}
                  <div className="bg-gradient-to-br from-primary to-secondary text-white p-6 md:w-32 flex flex-col justify-center items-center text-center">
                    <p className="text-sm font-semibold uppercase">{event.date.split("-")[0].trim().substring(0, 3)}</p>
                  ...
                  <div className="bg-muted/50 p-6 flex items-center justify-center border-t md:border-t-0 md:border-l md:border-border">
                    <Button className="bg-primary hover:bg-primary/90 text-white font-semibold">Register</Button>
                  </div>
                </div>
              </Card>
            ))}
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                {["Championship", "Tournament", "Workshop", "Training", "Qualifier"].map((cat) => (
